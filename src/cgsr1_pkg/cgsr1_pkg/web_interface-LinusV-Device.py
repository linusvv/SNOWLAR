...
HOME_FILE_PATH = os.path.expanduser("~/SNOWLAR/src/cgsr1_pkg/cgsr1_pkg/static/index_debug_alt_alt.html")
AUTOMATION_FILE_PATH = os.path.expanduser("~/SNOWLAR/src/cgsr1_pkg/cgsr1_pkg/static/automation.html")
...
def automation():
    if os.path.exists(AUTOMATION_FILE_PATH):
        return send_file(AUTOMATION_FILE_PATH)
    else:
        return "automation.html not found", 404
